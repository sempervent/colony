...
fn ui_system(
    ...
    match app_state.get() {
        ...
        AppState::InGame | AppState::Paused => {
            // Control bar window
            egui::Window::new("Control Bar")
                .default_size([800.0, 60.0])
                .show(ctx, |ui| {
                    ui.horizontal(|ui| {
            ...
            egui::Window::new("Simulator Controls")
                ...
                .show(ctx, |ui| {
                    ...
                    // Research/Rituals
                    ui.group(|ui| {
                        ui.label("Research & Rituals");
                        if ui.button("Start Ritual").clicked() {
                            println!("Starting research ritual...");
                            // TODO: Send StartRitual event
                        }
                        ui.label("Status: Not implemented yet");
                    });
                });
            ...
            // Job Queue and Workers window
            egui::Window::new("Job Queue & Workers")
                .default_size([400.0, 300.0])
                .show(ctx, |ui| {
                    ui.heading("Job Queue & Workers");
                    ui.add_space(10.0);
                    
                    ui.group(|ui| {
                        ui.label("Job Queue");
                        ui.label("Status: Not implemented yet");
                        ui.label("Pending jobs: 0");
                        ui.label("Completed jobs: 0");
                    });
                    ...
                    ui.group(|ui| {
                        ui.label("Workers");
                        ui.label("Status: Not implemented yet");
                        ui.label("Active workers: 0");
                        ui.label("Idle workers: 0");
                    });
                    ...
                    ui.group(|ui| {
                        ui.label("GPU Farm");
                        ui.label("Status: Not implemented yet");
                        ui.label("GPU utilization: 0%");
                        ui.label("Batches in flight: 0");
                    });
                });

            // Status bar window
            egui::Window::new("Status")
                .default_size([800.0, 40.0])
                .show(ctx, |ui| {
                    ui.horizontal(|ui| {
                        ui.label("Ready - Interactive UI Active");
                        ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                            ui.label(format!("FPS: {}", 60)); // TODO: Get actual FPS
                        });
                    });
                });
        }
